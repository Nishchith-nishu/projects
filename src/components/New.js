...
const View_detail = () => {
    return (
        <div>
            <Container fluid className="mx-3 mt-5" style={{ maxWidth: "100%"}}>
                <Card className="po">
                    <h5 className="mt-2 mx-4">₹40,000 See other charges</h5>
                    <h6 className="mx-4">2 BHK 1323 Sq-ft Flat/Apartment For Rent in Thanisandra Main Road, Bangalore</h6>
                    <Card.Body>
                        <div>
                            <Card.Img className="im" src="https://img.staticmb.com/mbphoto/property/cropped_images/2024/Apr/20/Photo_h300_w450/72437641_1_IMG-20240404-WA0050_300_450.jpg" />
                            <span className="ico">
                                <span className="mx-2"><BedIcon />2BEDS</span>
                                <span className="mx-2"><BathtubIcon />2Baths</span>
                                <span className="mx-2"><BalconyIcon />2Balconies</span>
                                <span className="mx-2"><CastleIcon />Semi-Furnished</span>
                            </span>
                            <p className="carp">
                                Carpet Area<br />
                                <b>917</b><br />
                        ...
                        <button className="own me-4">Contact Owner</button>
                        <button className="owne ">Ask Society Name</button>
                        <span className="one"><PersonIcon /></span>
                    </Card.Body>
                </Card>
            </Container>
        </div>
